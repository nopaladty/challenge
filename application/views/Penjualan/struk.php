                    ...
                    <div class="box-body">
                        <div id="wrapper">
                                        ...
                                        <table class="table table-striped table-condensed">
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    ...
                                                    <th colspan="2" class="text-right">5</th>
                                                </tr>
                                                <tr>
                            ...
                            <div id="buttons" style="padding-top:10px; text-transform:uppercase;" class="no-print">
                                ...
                                <span class="col-xs-12">
                                    <h3 class='box-title'>
                                        <center>Ambil Hadiah Mu!</center>
                                    </h3>
                                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Motor (5 point)</button>
                                        ...
                                        <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <h4>Selamat Anda Mendapatkan Motor!</h4>
                                                </div>
                                                <!-- footer modal -->
                                ...
                                <span class="col-xs-12">
                                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#asoy">Sepeda (5 point)</button>

                                    <div id="asoy" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                            <!-- konten modal-->
                                            <div class="modal-content">
                                                <!-- heading modal -->
                                                ...
                                                <!-- body modal -->
                                                <div class="modal-body">
                                                    <h4>Selamat Anda Mendapatkan Sepeda!</h4>
                                                </div>
                                                <!-- footer modal -->
                                                <div class="modal-footer">
                                                    <a class="btn btn-block btn-warning" href="<?php echo base_url() ?>index.php/penjualan">Kembali ke Penjualan</a>
                                ...
                                <span class="col-xs-12">
                                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#skut">Kulkas (5 point)</button>

                                    <div id="skut" class="modal fade" role="dialog">
                                        <div class="modal-dialog">
                                            <!-- konten modal-->
                                            <div class="modal-content">
                                                <!-- heading modal -->
                                                ...
                                                <!-- body modal -->
                                                <div class="modal-body">
                                                    <h4>Selamat Anda Mendapatkan Kulkas!</h4>
                                                </div>
                                                <!-- footer modal -->
                                                <div class="modal-footer">
                                                    <a class="btn btn-block btn-warning" href="<?php echo base_url() ?>index.php/penjualan">Kembali ke Penjualan</a>
