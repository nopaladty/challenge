        ...
        <div class="modal-content">
            <div id="datapayment">
                ...
                <div class="modal-body">
                    <form onSubmit="if(!confirm('Pembelian sukses, anda dapat bonus 5 point')){return false;}" action="<?= base_url('index.php/penjualan/transaksi'); ?>" method="POST" name="frm_byr">
                        <div class="row">
                            <div class="col-xs-12">
                                <div>
